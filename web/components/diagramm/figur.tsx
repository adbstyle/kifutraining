...
export function figurMarkup(args: {
  /** Welche Figur: Kind mit Pose, Torhüter oder Trainer (beide posenlos). */
  art: "spieler" | "torwart" | "trainer";
  pose?: SpielerPose;
  trikot: string;
  seed: string;
}): string {
