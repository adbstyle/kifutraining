        ...
        <div className="flex flex-col gap-3">
          {teams.map((team) => (
            <Link
              key={team.id}
              href={`/team/${team.id}`}
              className="focus-ring group rounded-[8px]"
            >
              <Card className="flex items-center gap-4 p-5 transition-colors group-hover:border-outline group-hover:bg-on-surface/5">
